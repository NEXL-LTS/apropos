  ...
  module Help
    ...
    COMMANDS = [
      ...
      Command.new("doctor", "Check the environment",
        ...
        "whether agent-apropos and Claude Code are on PATH, index freshness, and cache " \
        "writability."),
    ...
    AGENT_NOTE = "If you are an AI agent reading this (Claude Code, OpenCode, " \
                 "Gemini CLI, or other): agent-apropos injected context because a rule matched the file " \
